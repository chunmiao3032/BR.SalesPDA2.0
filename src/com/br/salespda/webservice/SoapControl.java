...
import com.br.salespda.basic.DateArraySerializer;
import com.br.salespda.basic.StringArraySerializer;
...
public class SoapControl {
	...
	static String NameSpace = "http://www.ln.crb.com/CrbLN/CRBPdaLNService/"; 
	...
	public static SoapPrimitive ExecuteWebMethod(String WebServiceUrl,String MethodName, Map map,int timeout)
	{
		try
		{
			url = WebServiceUrl;//Global.WebServiceUrl; // 临时注销，正式发布时打开
			soapAction = NameSpace + MethodName;
			// step1 指定WebService的命名空间和调用的方法名
			SoapObject request = new SoapObject(NameSpace, MethodName);
	...
	public static SoapObject ExecuteWebMethodReturnClass(String WebServiceUrl,String MethodName,Map map)
	{
		try
		{
			url = WebServiceUrl;//Global.WebServiceUrl; // 临时注销，正式发布时打开
